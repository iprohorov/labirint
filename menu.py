...
class MenuWindow(pygame_gui.elements.UIWindow):
    def __init__(self,
        ...
        self.menu_button_reload = pygame_gui.elements.UIButton(relative_rect= pygame.Rect((0, 0), (100, 50)),
                                             text='Reload',
                                             manager=self.ui_manager, container=self)
        self.menu_button_save = pygame_gui.elements.UIButton(relative_rect= pygame.Rect((0, 80), (100, 50)),
                                             text='Save',
                                             manager=self.ui_manager, container=self)
